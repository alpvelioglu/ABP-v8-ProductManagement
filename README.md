...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3d72053c-3820-480c-b7d6-5f742416aa2f
```

> `3d72053c-3820-480c-b7d6-5f742416aa2f` is the password of the certificate, you can change it to any password you want.
